 ...
 * primitives.
 *
 * $Revision: 1.4 $ $Last Revision Date: 2018/02/04 $
 *
...
public class Semaphore {
     ...
     * value because it's the only way it can become so. Wait() does not do that
     * for us. The semantic of that could be that how many threads are
     ...
     *
     * NOTE: This implementation as-is does not allow semaphore's value to
     * become negative.
     */
